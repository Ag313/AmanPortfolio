...
taskForce.addEventListener('dragleave', function (evt) {
  // HERE DRAGLEAVE KI VAJAH SE CLASS REMOVE HO JAEGI JESE PEHLE DOTTED LINE HO RAHI THI LEKIN HAT NAHI RI THI AB ISKI HELP SE HAT JAEGI
  evt.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60543" + '/');
